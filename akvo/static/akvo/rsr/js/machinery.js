/*globals jQ, error0, error1, error2, error3, error4, akvo_project_id, akvo_widget_type,akvo_widget_choice, akvo_widget_organisation, akvo_widget_site, document, location*/
(function () {
    "use strict";
    ...
    function getHeight(widget_type) {
        ...
        case 'project-narrow':
            return 840;
        case 'cobranded-narrow':
            return 911;
        case 'cobranded-short':
            return 627;
        case 'cobranded-banner':
            return 234;
        case 'cobranded-leader':
            return 207;
        default:
            return 840;
        }
    ...
    function preview_widget() {
        var error_message = '', colorsValidate = true, bgcolor = '', txtcolor = '',
            widget_height = '', widget_width = '', map_widget_state = '',
            akvo_widget_height = getHeight(akvo_widget_type), akvo_widget_width = getWidth(akvo_widget_type),
            akvo_widget_container = jQ('#akvo_widget_container'), codefield = jQ('#code'),
            akvo_url = '', widget_url = '',
            ifrm = document.createElement("IFRAME"), akvo_widget = document.getElementById('jswidget'),
            widget = jQ('#jswidget'), codesnippet = '';
        ...
        codesnippet = '<iframe src="' + widget_url + '" ';
        if (akvo_widget_choice !== 'project-map') {
