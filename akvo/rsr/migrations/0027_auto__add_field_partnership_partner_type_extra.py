...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partnership.partner_type_extra'
        db.add_column('rsr_partnership', 'partner_type_extra',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partnership.partner_type_extra'
        db.delete_column('rsr_partnership', 'partner_type_extra')
