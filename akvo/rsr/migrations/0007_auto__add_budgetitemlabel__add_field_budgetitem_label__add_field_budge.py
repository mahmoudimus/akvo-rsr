...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BudgetItemLabel'
        db.create_table('rsr_budgetitemlabel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True)),
        ))
        db.send_create_signal('rsr', ['BudgetItemLabel'])

        # Adding field 'BudgetItem.label'
        db.add_column('rsr_budgetitem', 'label', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rsr.BudgetItemLabel'], null=True), keep_default=False)

        # Adding field 'BudgetItem.other_extra'
        db.add_column('rsr_budgetitem', 'other_extra', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)

        # Adding unique constraint on 'BudgetItem', fields ['project', 'label']
        db.create_unique('rsr_budgetitem', ['project_id', 'label_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BudgetItem', fields ['project', 'label']
        db.delete_unique('rsr_budgetitem', ['project_id', 'label_id'])

        # Deleting model 'BudgetItemLabel'
        db.delete_table('rsr_budgetitemlabel')

        # Deleting field 'BudgetItem.label'
        db.delete_column('rsr_budgetitem', 'label_id')

        # Deleting field 'BudgetItem.other_extra'
        db.delete_column('rsr_budgetitem', 'other_extra')
    ...
    models = {
        ...
        'rsr.budgetitem': {
            ...
            'label': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rsr.BudgetItemLabel']", 'null': 'True'}),
            'other_extra': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
