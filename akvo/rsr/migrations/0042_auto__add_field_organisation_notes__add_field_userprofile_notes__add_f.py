...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.notes'
        db.add_column('rsr_organisation', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.notes'
        db.add_column('rsr_userprofile', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Invoice.notes'
        db.add_column('rsr_invoice', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ProjectUpdate.notes'
        db.add_column('rsr_projectupdate', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.notes'
        db.delete_column('rsr_organisation', 'notes')

        # Deleting field 'UserProfile.notes'
        db.delete_column('rsr_userprofile', 'notes')

        # Deleting field 'Invoice.notes'
        db.delete_column('rsr_invoice', 'notes')

        # Deleting field 'ProjectUpdate.notes'
        db.delete_column('rsr_projectupdate', 'notes')
