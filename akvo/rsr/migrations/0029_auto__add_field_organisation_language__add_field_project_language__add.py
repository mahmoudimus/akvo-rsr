...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.language'
        db.add_column('rsr_organisation', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=2),
                      keep_default=False)

        # Adding field 'Project.language'
        db.add_column('rsr_project', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=2),
                      keep_default=False)

        # Adding field 'ProjectUpdate.language'
        db.add_column('rsr_projectupdate', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.language'
        db.delete_column('rsr_organisation', 'language')

        # Deleting field 'Project.language'
        db.delete_column('rsr_project', 'language')

        # Deleting field 'ProjectUpdate.language'
        db.delete_column('rsr_projectupdate', 'language')
