...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rsr_partnertype', (
            ('id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=8, primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
        ))
        db.send_create_signal('rsr', ['PartnerType'])

        # Adding M2M table for field partner_types on 'Organisation'
        db.create_table('rsr_organisation_partner_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organisation', models.ForeignKey(orm['rsr.organisation'], null=False)),
            ('partnertype', models.ForeignKey(orm['rsr.partnertype'], null=False))
        ))
        db.create_unique('rsr_organisation_partner_types', ['organisation_id', 'partnertype_id'])


    def backwards(self, orm):
        # Deleting model 'PartnerType'
        db.delete_table('rsr_partnertype')

        # Removing M2M table for field partner_types on 'Organisation'
        db.delete_table('rsr_organisation_partner_types')
