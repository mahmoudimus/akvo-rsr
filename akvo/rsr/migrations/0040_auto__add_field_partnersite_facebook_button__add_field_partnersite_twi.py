...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerSite.facebook_button'
        db.add_column('rsr_partnersite', 'facebook_button',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerSite.twitter_button'
        db.add_column('rsr_partnersite', 'twitter_button',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerSite.facebook_button'
        db.delete_column('rsr_partnersite', 'facebook_button')

        # Deleting field 'PartnerSite.twitter_button'
        db.delete_column('rsr_partnersite', 'twitter_button')
