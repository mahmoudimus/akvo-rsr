...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organisation.iati_id'
        db.delete_column('rsr_organisation', 'iati_id')

        # Adding field 'Organisation.iati_org_id'
        db.add_column('rsr_organisation', 'iati_org_id',
        ...
        # Adding field 'Partnership.iati_activity_id'
        db.add_column('rsr_partnership', 'iati_activity_id',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partnership.internal_id'
        db.add_column('rsr_partnership', 'internal_id',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Organisation.iati_org_id'
        db.delete_column('rsr_organisation', 'iati_org_id')
        ...
        # Deleting field 'Partnership.iati_activity_id'
        db.delete_column('rsr_partnership', 'iati_activity_id')

        # Deleting field 'Partnership.internal_id'
        db.delete_column('rsr_partnership', 'internal_id')
    ...
    models = {
        ...
        'rsr.organisation': {
            ...
            'iati_org_id': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rsr.partnership': {
            ...
            'iati_activity_id': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internal_id': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
