...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectPartner'
        db.create_table('rsr_projectpartner', (
            ...
            ('partner_type', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('funding_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal('rsr', ['ProjectPartner'])


    def backwards(self, orm):
        
        # Deleting model 'ProjectPartner'
        db.delete_table('rsr_projectpartner')
