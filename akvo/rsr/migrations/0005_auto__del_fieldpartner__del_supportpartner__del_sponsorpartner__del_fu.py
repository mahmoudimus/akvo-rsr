...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectPartner.funding_amount'
        db.alter_column('rsr_projectpartner', 'funding_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Deleting field 'Organisation.sponsor_partner'
        db.delete_column('rsr_organisation', 'sponsor_partner')

        # Deleting field 'Organisation.funding_partner'
        db.delete_column('rsr_organisation', 'funding_partner')

        # Deleting field 'Organisation.field_partner'
        db.delete_column('rsr_organisation', 'field_partner')

        # Deleting field 'Organisation.support_partner'
        db.delete_column('rsr_organisation', 'support_partner')
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProjectPartner.funding_amount'
        db.alter_column('rsr_projectpartner', 'funding_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2))

        # Adding field 'Organisation.sponsor_partner'
        db.add_column('rsr_organisation', 'sponsor_partner', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Organisation.funding_partner'
        db.add_column('rsr_organisation', 'funding_partner', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Organisation.field_partner'
        db.add_column('rsr_organisation', 'field_partner', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Organisation.support_partner'
        db.add_column('rsr_organisation', 'support_partner', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'rsr.project': {
            ...
            'partners': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projects'", 'symmetrical': 'False', 'through': "orm['rsr.ProjectPartner']", 'to': "orm['rsr.Organisation']"}),
