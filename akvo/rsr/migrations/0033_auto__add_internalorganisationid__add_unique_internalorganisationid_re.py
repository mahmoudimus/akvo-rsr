...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InternalOrganisationID'
        db.create_table('rsr_internalorganisationid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recording_org', self.gf('django.db.models.fields.related.ForeignKey')(related_name='internal_ids', to=orm['rsr.Organisation'])),
            ('referenced_org', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reference_ids', to=orm['rsr.Organisation'])),
