...
ORG_TYPE_MAPPER_REV = dict(zip(ORG_TYPE_MAPPER.values(),ORG_TYPE_MAPPER.keys()))

class Migration(DataMigration):

    def forwards(self, orm):
        for obj in orm.Organisation.objects.all():
            obj.new_organisation_type = ORG_TYPE_MAPPER[obj.organisation_type]
            obj.save()

    def backwards(self, orm):
        for obj in orm.Organisation.objects.all():
            obj.organisation_type = ORG_TYPE_MAPPER_REV[obj.new_organisation_type]
            obj.save()
