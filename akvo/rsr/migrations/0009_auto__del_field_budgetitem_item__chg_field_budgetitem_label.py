...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BudgetItem.item'
    ...
    def backwards(self, orm):
        ...
        # Adding field 'BudgetItem.item'
        db.add_column('rsr_budgetitem', 'item', self.gf('django.db.models.fields.CharField')(default=0, max_length=20), keep_default=False)

        # Changing field 'BudgetItem.label'
        db.alter_column('rsr_budgetitem', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rsr.BudgetItemLabel'], null=True))
