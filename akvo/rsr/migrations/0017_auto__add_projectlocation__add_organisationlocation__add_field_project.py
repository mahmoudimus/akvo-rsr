...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rsr_projectlocation', (
            ...
            ('location_target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations', null=True, to=orm['rsr.Project'])),
        ))
        db.send_create_signal('rsr', ['ProjectLocation'])

        # Adding model 'OrganisationLocation'
        db.create_table('rsr_organisationlocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('latitude', self.gf('akvo.rsr.fields.LatitudeField')(default=0)),
            ('longitude', self.gf('akvo.rsr.fields.LongitudeField')(default=0)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('postcode', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('primary', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('location_target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations', null=True, to=orm['rsr.Organisation'])),
        ))
        db.send_create_signal('rsr', ['OrganisationLocation'])

        # Adding field 'Project.primary_location'
        db.add_column('rsr_project', 'primary_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['rsr.ProjectLocation']),
                      keep_default=False)

        # Adding field 'Organisation.primary_location'
        db.add_column('rsr_organisation', 'primary_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['rsr.OrganisationLocation']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'ProjectLocation'
        db.delete_table('rsr_projectlocation')

        # Deleting model 'OrganisationLocation'
        db.delete_table('rsr_organisationlocation')

        # Deleting field 'Project.primary_location'
        db.delete_column('rsr_project', 'primary_location_id')

        # Deleting field 'Organisation.primary_location'
        db.delete_column('rsr_organisation', 'primary_location_id')
    ...
    models = {
        ...
        'rsr.organisation': {
            ...
            'primary_location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rsr.OrganisationLocation']"}),
        ...
        'rsr.project': {
            ...
            'primary_location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rsr.ProjectLocation']"}),
