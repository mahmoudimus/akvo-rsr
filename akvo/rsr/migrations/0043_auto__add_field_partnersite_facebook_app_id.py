...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerSite.facebook_app_id'
        db.add_column('rsr_partnersite', 'facebook_app_id',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerSite.facebook_app_id'
        db.delete_column('rsr_partnersite', 'facebook_app_id')
