...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organisation.primary_location'
        db.alter_column('rsr_organisation', 'primary_location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rsr.OrganisationLocation'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Project.primary_location'
        db.alter_column('rsr_project', 'primary_location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rsr.ProjectLocation'], null=True, on_delete=models.SET_NULL))
    def backwards(self, orm):

        # Changing field 'Organisation.primary_location'
        db.alter_column('rsr_organisation', 'primary_location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['rsr.OrganisationLocation']))

        # Changing field 'Project.primary_location'
        db.alter_column('rsr_project', 'primary_location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['rsr.ProjectLocation']))
    models = {
        'auth.group': {
