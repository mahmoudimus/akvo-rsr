...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.new_organisation_type'
        db.add_column('rsr_organisation', 'new_organisation_type',
                      self.gf('django.db.models.fields.IntegerField')(default=22, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.new_organisation_type'
        db.delete_column('rsr_organisation', 'new_organisation_type')
