...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerSite.ui_translation'
        db.add_column('rsr_partnersite', 'ui_translation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerSite.google_translation'
        db.add_column('rsr_partnersite', 'google_translation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerSite.ui_translation'
        db.delete_column('rsr_partnersite', 'ui_translation')

        # Deleting field 'PartnerSite.google_translation'
        db.delete_column('rsr_partnersite', 'google_translation')
