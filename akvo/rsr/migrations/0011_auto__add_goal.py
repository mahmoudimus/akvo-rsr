...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Goal'
        db.create_table('rsr_goal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='goals', to=orm['rsr.Project'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('rsr', ['Goal'])


    def backwards(self, orm):
        
        # Deleting model 'Goal'
        db.delete_table('rsr_goal')
